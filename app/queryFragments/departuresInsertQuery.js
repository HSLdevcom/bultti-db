...
export const departuresInsertQuery = `
         ...
         departures_union AS (
             ...
             (
                 SELECT
                     ...
                     COALESCE(o.lnkalkusolmu, r.lnkalkusolmu, vpa.vastunnus) origin_stop_id,
                     r.stop_index                                            stop_index,
    ...
    SELECT
        ...
        1                                                            is_next_day,
        SPLIT_PART(COALESCE(departure.departure_time::varchar,
                            departure.origin_departure_time::varchar, '0.0'), '.',
                   1)::smallint                                      hours,
        SPLIT_PART(COALESCE(departure.departure_time::varchar,
                            departure.origin_departure_time::varchar, '0.0'), '.',
                   2)::smallint                                      minutes,
        SPLIT_PART(COALESCE(departure.origin_departure_time::varchar,
                            lah.lhlahaik::varchar, '0.0'), '.',
                   1)::smallint                                      origin_hours,
        SPLIT_PART(COALESCE(departure.origin_departure_time::varchar,
                            lah.lhlahaik::varchar, '0.0'), '.',
                   2)::smallint                                      origin_minutes,
        COALESCE(departure.arrival_is_next_day::smallint, lah.lhvrkvht::smallint,
                 0) =
        1                                                            arrival_is_next_day,
        SPLIT_PART(
                COALESCE(departure.arrival_time::varchar,
                         departure.origin_departure_time::varchar, '0.0'),
                '.',
                1
        ...
        COALESCE(aik.lavoimast, departure.date_begin, lah.lavoimast) date_begin,
        COALESCE(aik.laviimvoi, departure.date_end, lah.lavoimast)   date_end,
